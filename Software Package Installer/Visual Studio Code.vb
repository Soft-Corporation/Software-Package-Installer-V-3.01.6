...
Public Class Visual
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles Label6.Click
        ProgressBar1.Show()
        Timer1.Start()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_343d92b910984be3a189341090caf6a9.zip"), TextBox1.Text)
        Panel7.Hide()
        Panel1.Hide()
    End Sub
